import { ImageIcon, Sparkles, Hash } from 'lucide-react';
    ...
    return (
        <div className='h-full overflow-y-scroll p-6 flex items-start flex-wrap gap-4 text-slate-700'>
            ...
            <form onSubmit={onSubmitHandler} className='w-full max-w-lg p-4 bg-white rounded-lg border border-gray-200'>
                ...
                <textarea onChange={(e)=>setInput(e.target.value)} value={input} rows={4}  className='outline-none border border-gray-300 rounded-md text-sm mt-2 px-3 p-2 w-full' placeholder='Describe the image you want to generate...' required  />
                ...
                <button className='flex justify-center items-center gap-2 w-full bg-gradient-to-r from-[#00AD25] to-[#04FF50] text-white px-4 py-2 mt-6 text-sm rounded-lg cursor-pointer'>
